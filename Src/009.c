...
int main(void) {
    ...
    while (1) {
        ...
        SPI_PeripheralSwich(SPI2, ENABLE);
        ...
        SPI_PeripheralSwich(SPI2, DISABLE);
...
void SPI_Callback(SPI_Handle_t *pSPI, uint8_t c) {
    printf("Callback: %c\n", c);
}
void SPI2_IRQHandler(void) {
    SPI_CallbackFunc *callback = &SPI_Callback;
    SPI_IRQHandling(&SPI2handle, callback);
}
