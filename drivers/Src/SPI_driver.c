...
void SPI_Init(SPI_Handle_t *pSPIHandle) {
    ...
    cr1.MSTR = pSPIHandle->SPIConfig.SPI_DeviceMode;
    ...
    // 4.  Configure the DFF
    cr1.DFF = pSPIHandle->SPIConfig.SPI_DFF;

    // 5. configure the CPOL
    cr1.CPOL = pSPIHandle->SPIConfig.SPI_CPOL;

    // 6 . configure the CPHA
    cr1.CPHA = pSPIHandle->SPIConfig.SPI_CPHA;
